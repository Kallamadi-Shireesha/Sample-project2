...
class BookListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_list" do
    assert_difference('BookList.count') do
      post book_lists_url, params: { book_list: { book_id: @book_list.book_id, books_id: @book_list.books_id, description: @book_list.description, name: @book_list.name } }
    end
  ...
  test "should update book_list" do
    patch book_list_url(@book_list), params: { book_list: { book_id: @book_list.book_id, books_id: @book_list.books_id, description: @book_list.description, name: @book_list.name } }
