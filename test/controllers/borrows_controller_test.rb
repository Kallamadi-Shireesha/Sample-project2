...
class BorrowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create borrow" do
    assert_difference('Borrow.count') do
      post borrows_url, params: { borrow: { status: @borrow.status, user_id: @borrow.user_id, users_id: @borrow.users_id } }
    end
  ...
  test "should update borrow" do
    patch borrow_url(@borrow), params: { borrow: { status: @borrow.status, user_id: @borrow.user_id, users_id: @borrow.users_id } }
