...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { email: @sample.email, name: @sample.name, password: @sample.password } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { email: @sample.email, name: @sample.name, password: @sample.password } }
