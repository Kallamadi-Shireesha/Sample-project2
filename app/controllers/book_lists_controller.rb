class BookListsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @book_list.save
        format.html { redirect_to book_list_url(@book_list), notice: "Book list was successfully created." }
  ...
  def update
    respond_to do |format|
      if @book_list.update(book_list_params)
        format.html { redirect_to book_list_url(@book_list), notice: "Book list was successfully updated." }
  ...
  private
    ...
    def book_list_params
      params.require(:book_list).permit(:book_id, :name, :description, :books_id)
    end
end
